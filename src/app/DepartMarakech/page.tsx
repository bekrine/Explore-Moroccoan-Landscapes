...
const page = () => {
    return (
        <div className='flex flex-col items-center '>
            <h1 className='text-center text-6xl py-6 my-2 font-extrabold text-primaryColor'>CIRCUIT DEPART Marakech</h1>
